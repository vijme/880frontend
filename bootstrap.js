...
Ext.Loader.addClassPathMappings({
  ...
  "PatientVitalsMonitoring": "app"
});

Ext.ClassManager.addNameAlternateMappings({
  "DemoApp.model.login": [],
  "DemoApp.store.loginStore": [],
  ...
  "PatientVitalsMonitoring.controller.Account": [],
  "PatientVitalsMonitoring.view.LoginForm": [],
  "PatientVitalsMonitoring.view.MainView": [],
  "PatientVitalsMonitoring.view.MyRadioButton11": [],
  "PatientVitalsMonitoring.view.RegisterForm": [],
  "PatientVitalsMonitoring.view.vitalsDetails": []
});
